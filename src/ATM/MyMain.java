package ATM; // Java file MyMain is in the package ATM

public class MyMain {
    public static void main(String[] args) {
        CreditCard tbc = new CreditCard("Mr.", "Archil Sikharulidze", "5146-4309-1112-3409", 1200);
        CreditCard bog = new CreditCard("Mss.", "Teona Mamukishvili", "1345-1234-0923-0101", 1200);
